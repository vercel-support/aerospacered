...
<link rel="apple-touch-icon" href="https://aerospaceec.pythonanywhere.com/static/img/REA_Logo.png" />
    ...
    <div className={classes.AboutUsContainer}>
      <div className={classes.AboutUsBody}>
        ...
        <br/>
        <span> <img src='/call.svg' className={classes.imgTelephone}/> 0995578644 - Vicente Coronel</span></p>
        ...
        <span>  <span className={classes.bankTag}> <img src='/wallet.svg'/>Banco Pichincha: </span> &nbsp; 2206394987 - Vicente Coronel Rojas - vicente.coronelr@gmail.com</span></p>
      </div>
    </div>
        ...
        <div className={classes.ListaItemsWrapper}>
          <div className={classes.ListaItemsContainer}>
              <ul>
                ...
                <li className={classes.completed}> <p>Bateria 5000mAh - |</p><a href='' rel="noopener noreferrer" target="_blank"> Adquirido </a> </li>
                <li className={classes.completed}> <p>Hélice 9in - |</p><a href='' rel="noopener noreferrer" target="_blank"> Adquirido </a> </li>
                <li className={classes.completed}> <p>ESC 40 A - |</p><a href='' rel="noopener noreferrer" target="_blank"> Adquirido</a> </li>
                <li className={classes.completed}> <p>RaspBerry Pi 4 - |</p><a href='' rel="noopener noreferrer" target="_blank"> Adquirido</a> </li>
                <li className={classes.completed}> <p>Arduino Uno - |</p><a href='' rel="noopener noreferrer" target="_blank"> Adquirido </a> </li>
                <li className={classes.completed}> <p>Servomotores 180deg - |</p><a href='' rel="noopener noreferrer" target="_blank"> Adquirido</a> </li>
                ...
                <li> <p>Planchas de espumaflex - $15.00 | &nbsp;</p><a href='' rel="noopener noreferrer" target="_blank">  Pendiente</a> </li>
                <li> <p>Elementos elctrónicos varios - $5.00 | &nbsp;</p><a href='' rel="noopener noreferrer" target="_blank"> Pendiente </a> </li>
                <li> <p>Impresión 3D y corte laser - $20.00 | &nbsp;</p><a href='' rel="noopener noreferrer" target="_blank"> Pendiente </a> </li>
    ...
    <li className={classes.isActive}> <span>Bateria HBC</span></li>  
